...
public class OpenApiConfig {
        ...
        private static final String INSTANCE_EXAMPLE = "/v1/drivers";
    ...
    public OpenAPI driverServiceOpenAPI(
        ...
        private Example validationExample() {
                ...
                payload.put(PROP_ERRORS, Map.of(
                                "firstName", List.of("must contain only letters"),
                                "addressCommands[0].street", List.of("must not be blank")
                ));
        ...
        private Example businessExample() {
                ...
                payload.put(PROP_DETAIL, "Driver profile conflicts with an existing resource.");
                payload.put(PROP_INSTANCE, INSTANCE_EXAMPLE);
                payload.put(PROP_ERROR_CODE, 6);
                example.setValue(payload);
                return example;
        }
