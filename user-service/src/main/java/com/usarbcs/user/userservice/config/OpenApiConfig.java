...
public class OpenApiConfig {
        ...
        private static final String INSTANCE_EXAMPLE = "/api/v1/users";
        ...
        public OpenAPI userServiceOpenAPI(
                ...
                return new OpenAPI()
                                .info(new Info()
                                                ...
                                                .description("OpenAPI contract for the user microservice.")
                                                .version("v1"))
        ...
        private Example businessExample() {
                ...
                payload.put(PROP_DETAIL, "User rule validation failed.");
                payload.put(PROP_INSTANCE, INSTANCE_EXAMPLE);
