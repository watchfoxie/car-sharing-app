...
public class OpenApiConfig {
        ...
        private static final String INSTANCE_EXAMPLE = "/api/v1/payment";
    ...
    public OpenAPI paymentServiceOpenAPI(
        ...
        private Schema<?> baseProblemSchema() {
                ...
                schema.addProperty(PROP_REFERENCE, new StringSchema().description("Trace identifier to help troubleshooting.")
                                .nullable(true));
        ...
        private Example validationExample() {
                ...
                payload.put(PROP_ERRORS, Map.of(
                                "iban", List.of("must match country format"),
                                "currency", List.of("must be EUR or USD")
                ));
        ...
        private Example businessExample() {
                ...
                payload.put(PROP_DETAIL, "Account already contains an active card with the same fingerprint.");
                payload.put(PROP_INSTANCE, INSTANCE_EXAMPLE);
                payload.put(PROP_ERROR_CODE, 1204);
                example.setValue(payload);
                return example;
        }
