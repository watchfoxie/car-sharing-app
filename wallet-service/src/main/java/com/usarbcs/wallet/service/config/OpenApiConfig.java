...
public class OpenApiConfig {
        ...
        private static final String INSTANCE_EXAMPLE = "/api/v1/wallet";
        ...
        private Schema<?> baseProblemSchema() {
                ...
                schema.addProperty(PROP_TITLE, new StringSchema().description("Human readable summary."));
                schema.addProperty(PROP_STATUS, new Schema<>().type("integer").format("int32").description("HTTP status code."));
                schema.addProperty(PROP_DETAIL, new StringSchema().description("Detailed explanation."));
                schema.addProperty(PROP_INSTANCE, new StringSchema().format("uri").description("Failing request URI."));
        ...
        private Example validationExample() {
                ...
                payload.put(PROP_ERRORS, Map.of(
                                "walletId", List.of("must be a valid UUID"),
                                "amount", List.of("must be greater than zero")
                ));
        ...
        private Example businessExample() {
                ...
                payload.put(PROP_DETAIL, "Wallet balance is insufficient for this operation.");
                payload.put(PROP_INSTANCE, INSTANCE_EXAMPLE);
        ...
        private Example internalServerExample() {
                ...
                payload.put(PROP_DETAIL, "We could not process the wallet request at this time.");
                payload.put(PROP_INSTANCE, INSTANCE_EXAMPLE);
